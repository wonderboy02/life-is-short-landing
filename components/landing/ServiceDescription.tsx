        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="rounded-3xl border border-neutral-200 bg-white p-8 text-center shadow-lg md:p-12">
            <div className="space-y-6">
              <p className="leading-relaxed text-neutral-800 md:text-2xl md:leading-relaxed">
              ...
              <p className="leading-relaxed text-neutral-600 md:text-2xl md:leading-relaxed">
                기술의 한계로 인해{' '}
