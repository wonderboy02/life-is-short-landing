            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <p className="text-sm text-neutral-700">
                  <span className="font-semibold text-neutral-900">링크 공유</span> - 가족들에게 카톡으로 전송
                </p>
              </div>
              <div className="flex items-center gap-3">
                <div className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-neutral-900 text-sm font-bold text-white">
                ...
                <p className="text-sm text-neutral-700">
                  <span className="font-semibold text-neutral-900">함께 업로드</span> - 각자 갖고 있는 사진을 자유롭게
                </p>
              </div>
              <div className="flex items-center gap-3">
                <div className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-neutral-900 text-sm font-bold text-white">
                ...
                <p className="text-sm text-neutral-700">
                  <span className="font-semibold text-neutral-900">하나의 영상으로</span> - 모든 추억을 담아 완성
                </p>
              </div>
            </div>
          </div>
